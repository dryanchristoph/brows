                ...
                <div class="row">
                                ...
                                <div class="tab-pane fade {{ ($step == 'step1' || !$step) ? ' show active' : '' }}" id="step1">
                                    <div class="tab-pane-inside">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="row">
                                                    <label class="text-uppercase">Penyewa Barang :</label>
                                                </div>
                                                <div class="row marg-top-sm">
                    ...
                    <div class="col-md-4 mt-2 mt-md-5">
                        ...
                        <div class="cart-table cart-table--sm">
                            <div class="cart-table-prd cart-table-prd-headings d-none d-lg-table cd-bg-white">
                                <div class="cart-table-prd-name">

                                </div>
                            </div>
                            <div class="cart-table-prd cart-table-prd-headings d-none d-lg-table cd-bg-white">
                                <div class="cart-table-prd-image">Status</div>
                                <div class="cart-table-prd-name">
                                    <h3 class="label-status-trans text-right">
