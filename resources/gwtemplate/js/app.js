		...
		megaMenu: function () {
			var MegaMenu = {
				MegaMenuData: {
					...
					headerCart: '.minicart-js',
					headerCartToggleBtn: '.minicart-link-bak',
			...
			productGallery = function () {
				...
				function _elevateZoom(el) {
					var _ = el,
						...
						//console.log($zoomImg[0].dataset.zoomImage)
						//console.log('zoomImg:');
						//console.log($zoomImg);
					...
					if (!$('body').hasClass('touch')) {
						...
						//$('img.zoom').attr('src',$zoomImg[0].dataset.zoomImage);
						//console.log('src set');
				...
				function _previewsCarousel(el, carousel, zoom) {
					...
					$this.on('init', function () {
						...
						$('.slick-slide', $this).on('click', function () {
							...
							setTimeout(function () {
								...
								$mainImg.attr('src', slickselector.attr('data-zoom-image'));
					...
					$this.on('click', '.slick-slide', function (e) {
						...
						if (zoom === 'nozoom' || $('body').hasClass('touch')) {
							...
							//$mainImg.attr('src', 'http://localhost/brows/public/resources/fileUploads/productImages/CUST00000004/PROD00000004-IMG02.jpg?cf=20191103043156');
						}
						//$mainImg.attr('src', $(this).attr('data-zoom-image'));
						//console.log('newimg = '+$(this).attr('data-zoom-image'));
					});
					//});
				}
			};
